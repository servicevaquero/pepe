...
class ElegirPresentacionW(parent: WindowOwner, unElector: ElegirClienteYEntrada) extends Dialog[ComprarEntrada](parent, new ComprarEntrada(unElector.entradaSeleccionada)) {
